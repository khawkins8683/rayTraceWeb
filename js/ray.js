...
//Now combine the functions into a single ray object to pass to npm
let ray = {
    newSegment: function(r=[0,0,0],k=[0,0,1],lambda=550,eta=[0,0,1],d=0,surfID=0,nObj={n1:1,n2:1},aoi=0,type="refract"){
        return new RaySegment(r,k,lambda,eta,d,surfID,nObj,aoi,type)
    },
    newRayField: function(pathList){
        return new RayField(pathList)
    },
    newRayGrid: function(n,r,rayRChief=[0,0,0],rayK=[0,0,1],lambda=550){
        return new CollimatedWavefrontGrid(n,r,rayRChief,rayK,lambda)
    }
}
